...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VisitRequest.status'
        db.add_column('queue_visitrequest', 'status', self.gf('django.db.models.fields.CharField')(default='pending', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VisitRequest.status'
        db.delete_column('queue_visitrequest', 'status')

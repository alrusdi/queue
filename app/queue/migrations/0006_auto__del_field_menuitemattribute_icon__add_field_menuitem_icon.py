...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MenuItem.icon'
        db.add_column('queue_menuitem', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MenuItem.icon'
        db.delete_column('queue_menuitem', 'icon')

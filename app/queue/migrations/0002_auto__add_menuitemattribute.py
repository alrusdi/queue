...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MenuItemAttribute'
        db.create_table('queue_menuitemattribute', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('menu_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['queue.MenuItem'])),
            ('field_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('field_value', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('queue', ['MenuItemAttribute'])


    def backwards(self, orm):
        
        # Deleting model 'MenuItemAttribute'
        db.delete_table('queue_menuitemattribute')
    ...
    models = {
        ...
        'queue.menuitemattribute': {
            ...
            'field_value': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
